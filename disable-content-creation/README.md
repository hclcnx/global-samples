# HCL Connections Cloud - Disable Content Creation Customization
...
The files that enable the hiding of the elements are made available and are directly referencable from the public git repository [hclcnx
/
global-samples](https://github.com/hclcnx/global-samples) in the [disable-content-creation](https://github.com/hclcnx/global-samples/tree/master/disable-content-creation) directory.
...
5. Remove the example JSON outline that is present by default and then copy/paste the JSON from the [disable-icc-extension.json](https://github.com/hclcnx/global-samples/tree/master/disable-content-creation/disable-icc-extension.json) file.
